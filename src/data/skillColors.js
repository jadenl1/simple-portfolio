export const skillColorMap = {
	...
	TensorFlow: { bg: "rgba(255, 111, 0, 0.2)", text: "#FFEFE0" },
	Pandas: { bg: "rgba(19, 2, 84, 0.2)", text: "#E3E0FF" },
	Django: { bg: "rgba(12, 75, 51, 0.2)", text: "#DCF3E8" },
	GCP: { bg: "rgba(26, 115, 232, 0.2)", text: "#E0F3FE" },
	Express: { bg: "rgba(120, 124, 128, 0.2)", text: "#ECEFF1" },
	"AWS Fargate": { bg: "rgba(255, 153, 0, 0.2)", text: "#FFEBCD" },
	ElastiCache: { bg: "rgba(88, 86, 214, 0.2)", text: "#E4E3FF" },
	Twilio: { bg: "rgba(242, 47, 70, 0.2)", text: "#FFE3E7" },
